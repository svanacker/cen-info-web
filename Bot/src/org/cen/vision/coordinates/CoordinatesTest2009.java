...
public class CoordinatesTest2009 {
	...
	private void initGUI() {
		...
		image1.addMouseMotionListener(new MouseMotionAdapter() {
			private Point2D dst = new Point2D.Double();

			@Override
			public void mouseMoved(MouseEvent e) {
				Point2D p = c.screenToGameBoard(e.getX(), e.getY());
				handler.getTransform().transform(p, dst);
	...
	private void addInputSelector(Container cp, GridBagConstraints gbc) {
		...
		String[] values = new String[] { "CoordinatesTestG1.jpg", "CoordinatesTestG2.jpg", "CoordinatesTestG3.jpg", "CoordinatesTestG4.jpg", "CoordinatesTestG5.jpg", "CoordinatesTestG6.jpg", "CoordinatesTestG7.jpg", "CoordinatesTestG8.jpg", "CoordinatesTestG9.jpg", "CoordinatesTestG10.jpg", "CoordinatesTestR1.jpg", "CoordinatesTestR2.jpg", "CoordinatesTestR3.jpg", "CoordinatesTestR4.jpg", "CoordinatesTestR5.jpg", "CoordinatesTestR6.jpg", "CoordinatesTestR7.jpg", "CoordinatesTestR8.jpg", "CoordinatesTestR9.jpg", "CoordinatesTestR10.jpg", };
	...
	private void addMatchSideControl(Container cp, GridBagConstraints gbc) {
		...
		cb.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				...
				colorAngle = (cb.isSelected()) ? ConfigurationAnalyzer.COLOR_ANGLE_RED : ConfigurationAnalyzer.COLOR_ANGLE_GREEN;
	...
	private void initializeWebCam() {
		InputStream is = getClass().getClassLoader().getResourceAsStream("org/cen/cup/cup2009/robot/robot2009.properties");
