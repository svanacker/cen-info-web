 ...
 */
@DeviceDataSignature(deviceName = "Battery", methods = { @DeviceMethodSignature(header = BatteryReadInData.HEADER,
		type = DeviceMethodType.OUTPUT, parameters = { @DeviceParameter(name = "value", length = 4,
				type = DeviceParameterType.UNSIGNED, unit = "milliVolt") }) })
