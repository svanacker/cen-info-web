 ...
 * from the client.
 */
@DeviceDataSignature(deviceName = "configuration", methods = { @DeviceMethodSignature(header = ConfigurationReadInData.HEADER,
		type = DeviceMethodType.OUTPUT, parameters = { @DeviceParameter(length = 4, name = "value",
