...
/**
 * Abstract Manager which is common between TCPManager and ComManger.
 */
public abstract class AbstractComManager implements Runnable, IComService {
	 ...
	 */
	protected InDataDecoder decoder;

	/**
	 * Service object providing incoming data decoders.
	 */
	protected final InDataDecodingService decodingService = new InDataDecodingService();

	protected final ComServiceListener comServiceListener = new ComServiceListener();
