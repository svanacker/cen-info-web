...
public class JpegImagesToMovie implements ControllerListener, DataSinkListener {
	...
	public static void main(String args[]) {
		...
		if (!outputURL.endsWith(".mpeg") && !outputURL.endsWith(".MPEG")) {
	...
	public boolean doIt(int width, int height, int frameRate, Vector inFiles, MediaLocator outML) {
		ImageDataSource ids = new ImageDataSource(width, height, 15, inFiles);
		Image image = Toolkit.getDefaultToolkit().getImage("d:\\brw.jpg");
		new ImageIcon(image);
		// PushImageDataSource ids = new PushImageDataSource(image);
