...
public class Trajectory extends AbstractGameBoardElement {
	...
	private static final Stroke GAUGE_STROKE = new BasicStroke(320,
			BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);

	private static final Stroke OUTLINE_STROKE = new BasicStroke(1,
			BasicStroke.CAP_SQUARE, BasicStroke.JOIN_MITER, 10, new float[] {
					15, 15 }, 0);

	private static final Color[] TRAJECTORY_COLOR = { Color.BLUE, Color.PINK,
			Color.ORANGE };
