...
/* package */final class StrategyHandler2011Context extends statemap.FSMContext {
	// ---------------------------------------------------------------
	// Member methods.
	//

	public StrategyHandler2011Context(StrategyHandler2011 owner) {
		super();
	...
	public StrategyHandler2011Context(StrategyHandler2011 owner, StrategyHandler2011State initState) {
		super();
		_owner = owner;
		setState(initState);
	...
	public StrategyHandler2011State getState() throws statemap.StateUndefinedException {
		if (_state == null) {
			throw (new statemap.StateUndefinedException());
		}

		return ((StrategyHandler2011State) _state);
	}

	protected StrategyHandler2011 getOwner() {
		return (_owner);
	}

	public void setOwner(StrategyHandler2011 owner) {
		if (owner == null) {
	...
	transient private StrategyHandler2011 _owner;

	// ---------------------------------------------------------------
	// Inner classes.
	//

	public static abstract class StrategyHandler2011State extends statemap.State {
		// -----------------------------------------------------------
		// Member methods.
		//

		protected StrategyHandler2011State(String name, int id) {
			super(name, id);
		}

		protected void Entry(StrategyHandler2011Context context) {
		}

		protected void Exit(StrategyHandler2011Context context) {
		}

		protected void CollisionDetected(StrategyHandler2011Context context) {
			Default(context);
		}

		protected void ConfigurationDone(StrategyHandler2011Context context) {
			Default(context);
		}

		protected void MatchStarted(StrategyHandler2011Context context) {
			Default(context);
		}

		protected void MatchStopped(StrategyHandler2011Context context) {
			Default(context);
		}

		protected void RobotInitializationDone(StrategyHandler2011Context context) {
			Default(context);
		}

		protected void Start(StrategyHandler2011Context context) {
			Default(context);
		}

		protected void Default(StrategyHandler2011Context context) {
	...
	protected static class GlobalStrategy_Default extends StrategyHandler2011State {
		// -----------------------------------------------------------
		// Member methods.
		//
		...
		@Override
		protected void Default(StrategyHandler2011Context context) {
			StrategyHandler2011 ctxt = context.getOwner();

			StrategyHandler2011State endState = context.getState();
