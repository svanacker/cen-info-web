...
public class Triangulation {
	public Point2D anglesToPos(double alpha1, double alpha2, double alpha3, double L, double l) {
		...
		double thetar = -alpha1 - Math.atan((-l * Math.tan(alpha1 - alpha3) + 2 * L) * Math.tan(alpha1 - alpha2) / (2 * L * Math.tan(alpha1 - alpha2) * Math.tan(alpha1 - alpha3) - l * Math.tan(alpha1 - alpha2) + 2 * l * Math.tan(alpha1 - alpha3)));
		if (thetar < 0)
			thetar = 2 * Math.PI + thetar;
		// position
		double x = -l * Math.tan(thetar + alpha1) / (Math.tan(thetar + alpha2) - Math.tan(thetar + alpha1));
		double y = L + l * Math.tan(thetar + alpha1) * Math.tan(thetar + alpha2) / (Math.tan(thetar + alpha1) - Math.tan(thetar + alpha2));
