...
public class TrajectoryCurveComputerTest {
	...
	private void testCurve(TrajectoryCurve curve, double expectedAngle, double expectedRadius, double expectedDistance, Direction expectedDirection) {
	...
	private void testControlPoint(TrajectoryCurve curve, double expectedStartOrientation, double expectedEndOrientation, Point2D expectedStartPosition, Point2D expectedEndPosition, Point2D expectedICR) {
	...
	public void testControlPointStraight_1() {
		TrajectoryCurve curve = new TrajectoryCurve(15.707963267948966192313216916398, 17.278759594743862811544538608037);
		testControlPoint(curve, 0, Math.PI / 2d, new Point2D.Double(0, 0), new Point2D.Double(-10.5, 10.5), new Point2D.Double(-10.5, 0));
	}
