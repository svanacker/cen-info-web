...
public class TrajectoryControlPoint {
	 ...
	 */
	public TrajectoryControlPoint(TrajectoryCurve curve, Point2D startPosition, Point2D endPosition, double startOrientation, double endOrientation, Point2D icr) {
		super();
		this.curve = curve;
