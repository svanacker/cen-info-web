...
public class Vision2011Handler extends AbstractDeviceHandler {
	...
	public Vision2011Handler(IRobotServiceProvider servicesProvider,
			GameboardConfigurationHandler2011 gameBoardConfigurationHandler,
			IMatchStrategyHandler strategyHandler) {
