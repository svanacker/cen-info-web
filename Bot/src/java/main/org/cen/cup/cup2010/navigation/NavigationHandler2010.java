...
public class NavigationHandler2010 extends AbstractDeviceHandler {
    ...
    private final Map<String, Location> mapLocations = new HashMap<String, Location>();

    private final Set<PathSegment> pathSegments = new HashSet<PathSegment>();
    ...
    private void initializeLocationGroups() {
        ...
        strategyHandler.addLocationGroup(pathSegments, new LocationGroup2010("blue central", blueGoal * 2), "R2C0",
                "R4C1", "R6C2", "R8C3", "R10C4", "blue end");
        strategyHandler.addLocationGroup(pathSegments, new LocationGroup2010("blue left", 0), "R10C2", "R12C3");
        strategyHandler.addLocationGroup(pathSegments, new LocationGroup2010("blue right", yellowGoal), "R0C1", "R2C2",
                "R4C3", "R6C4", "R8C5");
        strategyHandler.addLocationGroup(pathSegments, new LocationGroup2010("yellow central", yellowGoal * 2),
                "R10C0", "R8C1", "R6C2", "R4C3", "R2C4", "yellow end");
        strategyHandler.addLocationGroup(pathSegments, new LocationGroup2010("yellow right", 0), "R2C2", "R0C3");
        strategyHandler.addLocationGroup(pathSegments, new LocationGroup2010("yellow left", blueGoal), "R12C1",
                "R10C2", "R8C3", "R6C4", "R4C5");
