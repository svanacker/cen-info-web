...
public class Specific2010Device extends AbstractRobotDevice implements InDataListener {
    ...
    private void addCollectCornOutData(List<OutData> list, Side side,
            org.cen.cup.cup2010.device.specific2010.CollectCorn2010Request.Action action) {
        addOutData(list, new CollectCorn2010OutData(side, action));
    }

    private void addCollectTomatoOutData(List<OutData> list,
            org.cen.cup.cup2010.device.specific2010.CollectTomato2010Request.Action action) {
    ...
    private OutData getCollectCornOutData(org.cen.cup.cup2010.device.specific2010.CollectCorn2010Request.Side side,
            org.cen.cup.cup2010.device.specific2010.CollectCorn2010Request.Action action) {
    ...
    private OutData getCollectOrangeOutData(
            org.cen.cup.cup2010.device.specific2010.CollectOrange2010Request.Action action) {
        return new CollectOrange2010OutData(action);
    }

    private OutData getCollectTomatoOutData(
            org.cen.cup.cup2010.device.specific2010.CollectTomato2010Request.Action action) {
