...
public class GameBoard2012 extends AbstractGameBoard {
	...
	private void addElements() {
		elements.add(new Board(COLOR_BOARD_2012, GameBoard2012.BOARD_WIDTH,
				GameBoard2012.BOARD_HEIGHT));

		elements.add(new StartArea2012(StartArea2012.PURPLE, 0d, 0d));

		elements.add(new StartArea2012(StartArea2012.RED, 0, BOARD_HEIGHT
				- StartArea2012.START_AREA_HEIGHT));
		...
		elements.add(new ShipHold(BOARD_WIDTH - ShipHold.SHIP_HOLD_WIDTH,
				BOARD_HEIGHT - ShipHold.SHIP_HOLD_HEIGHT));

		double bottleDistance1 = 640d;
		double bottleDistance2 = 640d + 477d;

		// Bottle Red
		elements.add(new Bottle("bottle1red", BOARD_WIDTH, bottleDistance2,
				Color2012.RAL_3001));
		// Bottle Red
		elements.add(new Bottle("bottle2red", BOARD_WIDTH, BOARD_HEIGHT
				- bottleDistance1, Color2012.RAL_3001));

		// Bottle Red
		elements.add(new Bottle("bottle1purple", BOARD_WIDTH, BOARD_HEIGHT
				- bottleDistance2, Color2012.RAL_4008));
		// Bottle Red
		elements.add(new Bottle("bottle2purple", BOARD_WIDTH, bottleDistance1,
				Color2012.RAL_4008));
		...
		elements.add(new BlackCoin(BOARD_WIDTH - 300,
				BOARD_MIDDLE_HEIGHT + 100d));
		elements.add(new BlackCoin(BOARD_WIDTH - 300,
				BOARD_MIDDLE_HEIGHT - 100d));
		...
		elements.add(new Bullion(BOARD_WIDTH - 647d, BOARD_MIDDLE_HEIGHT,
				Math.PI / 2));

		// Bullion aligned to the captain boat area
		double bullionShift = 420d;
		double bullionOrientation = Math.PI / 50;
		elements.add(new Bullion(StartArea2012.START_AREA_WIDTH + 285d,
				bullionShift, -bullionOrientation));
		elements.add(new Bullion(StartArea2012.START_AREA_WIDTH + 285d,
				GameBoard2012.BOARD_HEIGHT - bullionShift, +bullionOrientation));
	}
