...
public class GameboardConfigurationHandler2009 implements IGameboardConfigurationHandler {
    ...
    private final DebugEvent debugEvent = new DebugEvent(this);
    ...
    private final FilterInterruptor interruptor = new FilterInterruptor();
    ...
    private int analyzeRegion(Region r) {
        ...
        transform.transform(AwtAdapterUtils.toAwtPoint2D(p), AwtAdapterUtils.toAwtPoint2D(p));
