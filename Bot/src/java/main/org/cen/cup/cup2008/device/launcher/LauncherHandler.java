...
public class LauncherHandler {
	...
	private void loadBall() throws InterruptedException {
		...
		open();
		Thread.sleep(PAUSE);
		// bascule le contrôleur d'admission des balles
		changeLock();
	}

	/**
	 * Positionnement des balles et du contrôleur d'admission
	 * 
	 * <pre>
	 * - Balle1 .   . | X 
	 * - Balle2 . | X   X 
	...
	public void sequence1() {
		try {
			...
			open();
			Thread.sleep(PAUSE);
			// se met en place auprès du conteneur
			moveToDispenser();
