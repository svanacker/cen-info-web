...
public class TrajectoryBuilder implements ResourceLoaderAware {
    ...
    private void buildTrajectoryOutData() {
        List<IRobotDeviceRequest> requests = new ArrayList<>();
        Holder<Double> o = new Holder<Double>(new Double(0));
        List<IRobotDeviceRequest> phaseRequests = getRequests(displayedTrajectory, o);
    ...
    private List<IRobotDeviceRequest> getRequests(String trajectory, Holder<Double> initialOrientation) {
        String prefix = "";
