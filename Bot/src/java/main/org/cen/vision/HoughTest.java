...
public class HoughTest {
	...
	private double cameraVisionAngle = Math.toRadians(45);
	...
	private WebCamProperties wcp = new WebCamProperties();
	...
	private void addImageSelection(Container c, GridBagConstraints gbc) {
		String[] items = { "TestG1.jpg", "TestG2.jpg", "TestG3.jpg", "TestG4.jpg", "TestG5.jpg", "TestR1.jpg", "TestR2.jpg", "TestR3.jpg", "TestR4.jpg", "TestR5.jpg" };
