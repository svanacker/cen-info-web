 ...
 * DllSurrogate: [HKEY_LOCAL_MACHINE\SOFTWARE\Classes\AppID\{863C43AB-
 * 00EB-483F-B886-BFC137F3C779}] "DllSurrogate"=""
 * 
...
public class LogitechDeviceManager {
    ...
    private final IJIComObject instance;

    private final JIComServer server;
    ...
    public LogitechDeviceManager() throws Exception {
        ...
        // JIComFactory.createCOMInstance(JIComFactory.IID_IDispatch, instance);
    }
    ...
    public void initialize(String bstrSubscriberID, String bstrApplicationPath) {
        try {
            dispatch.callMethod("Initialize", new Object[] { new JIString(bstrSubscriberID),
                    new JIString(bstrApplicationPath) });
        } catch (JIException e) {
            log(e);
        }
    }
