<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<rich:panel>
		...
		<h:panelGrid columns="4">
			...
			<h:panelGrid columns="2" border="0" style="border: 1px solid black;">
				<h:form id="reductionFactor">
					...
					<rich:inputNumberSlider minValue="0"
						value="#{MotorComputeView.reductionFactor}" maxValue="100" step="1" width="400">
			...
			<h:panelGrid columns="2" border="0" style="border: 1px solid black;">
				<h:form id="encoderCounter">
					...
					<rich:inputNumberSlider minValue="0"
						value="#{MotorComputeView.encoderCounter}" maxValue="30000" step="100" width="400">
		...
		<h:panelGrid columns="2" border="0">
			...
			<h:outputText value="#{MotorComputeView.rotationBySecondAtReductor * MotorComputeView.encoderCounter} Hz"/>
			<h:outputText value="Min sample frequency to decode both motors : "/>
			<h:outputText value="#{MotorComputeView.rotationBySecondAtReductor * MotorComputeView.encoderCounter * 2 * 2} Hz"/>
			<h:outputText value="Precision of the robot : "/>
			<h:outputText value="#{MotorComputeView.wheelDiameter * 1000 * 3.14159 / (MotorComputeView.encoderCounter)} mm"/>
