...
@OutDataSender(classes = { MoveForwardOutData.class, MoveBackwardOutData.class, RotateLeftOutData.class, RotateRightOutData.class, RotateLeftOneWheelOutData.class, RotateRightOneWheelOutData.class, MoveOutData.class, StopOutData.class, ReadPIDOutData.class, ReadPositionPulseOutData.class, SetInitialPositionOutData.class, StopOutData.class, WritePIDOutData.class, CalibrationOutData.class })
public class NavigationDevice extends AbstractRobotDevice implements InDataListener {
